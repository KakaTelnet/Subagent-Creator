...
TOML files, project agent settings, model assignments, skill paths, and managed
file ownership. It requires Python 3.11 or newer, exits with 0 on success, and
exits with 1 on validation failures.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(
            ...
            f"{report['runtime_permissions']['status']}"
        )
